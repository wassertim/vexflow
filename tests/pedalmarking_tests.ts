...
export const PedalMarkingTests = (function() {
  return {
    test: function(makePedal) {
      return function(options) {
        ...
        const stave0 = vf.Stave(<IFactoryParams>{ width: 250 }).addTrebleGlyph();
        ...
        const stave1 = vf.Stave(<IFactoryParams>{ width: 260, x: 250 });
