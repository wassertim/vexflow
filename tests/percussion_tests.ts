...
import { Stave, StaveNote, TickContext, Tremolo } from '../src';
...
function createSingleMeasureTest(setup) {
  return function(options) {
    ...
    const stave = vf.Stave().addClef('percussion');
...
export const PercussionTests = (function() {
  ...
  return {
    Start: function() {
      ...
      run('Percussion Basic0', createSingleMeasureTest(function(vf) {
        const voice0 = vf.Voice().addTickables([
        ...
        const voice1 = vf.Voice().addTickables([
      ...
      run('Percussion Snare2', createSingleMeasureTest(function(vf) {
        vf.Voice().addTickables([
          vf.StaveNote({ keys: ['c/5'], duration: '4', stem_direction: -1 })
            .addArticulation(0, new Tremolo(1)),
          vf.GraceNote({ keys: ['c/5'], duration: '4', stem_direction: -1 })
            .addArticulation(0, new Tremolo(1)),
          vf.StaveNote({ keys: ['c/5'], duration: '4', stem_direction: -1 })
            .addArticulation(0, new Tremolo(3)),
          vf.StaveNote({ keys: ['c/5'], duration: '4', stem_direction: -1 })
            .addArticulation(0, new Tremolo(5)),
        ]);
      }));
      ...
      run('Percussion Snare3', createSingleMeasureTest(function(vf) {
        vf.Voice().addTickables([
          vf.StaveNote({ keys: ['c/5'], duration: '4', stem_direction: 1 })
            .addArticulation(0, new Tremolo(2)),
          vf.GraceNote({ keys: ['c/5'], duration: '4', stem_direction: 1 })
            .addArticulation(0, new Tremolo(2)),
          vf.GraceNote({ keys: ['c/5'], duration: '4', stem_direction: 1 })
            .addArticulation(0, new Tremolo(3)),
