 ...
 */
import { KeyManager, Music } from '../src';
...
export const MusicTests = (function() {
  return {
    ...
    relativeNotes: function() {
      ...
      let value = music.getRelativeNoteValue(music.getNoteValue('c'),
    ...
    scaleTones: function() {
      ...
      const c_major = music.getScaleTones(
        music.getNoteValue('c'), Music.scales.major);
      ...
      // Dorian
      const c_dorian = music.getScaleTones(
        music.getNoteValue('c'), Music.scales.dorian);
      ...
      // Mixolydian
      const c_mixolydian = music.getScaleTones(
        music.getNoteValue('c'), Music.scales.mixolydian);
