...
import { Barline, Stave, StaveModifier } from '../src';

declare const QUnit: any;
declare function ok(...args);
declare function equal(...args);

export const StaveModifierTests = (function() {
  return  {
    Start: function() {
      QUnit.module('StaveModifier');
      Test.runTests('Stave Draw Test', this.draw);
      Test.runTests('Vertical Bar Test', this.drawVerticalBar);
      Test.runTests('Begin & End StaveModifier Test', this.drawBeginAndEnd);
    },
