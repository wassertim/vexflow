...
declare function notOk(...args);
declare function test(...args);
declare function notDeepEqual(...args);
declare function notEqual(...args);
declare function strictEqual(...args);
declare function notStrictEqual(...args);
declare function deepEqual(...args);

export const FractionTests = (function() {
  return {
    Start: function() {
