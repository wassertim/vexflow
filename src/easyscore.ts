...
export class Grammar {
  ...
  KEY(): IGrammarVal {
    return {token: '[a-zA-Z][a-zA-Z0-9]*'} as IGrammarVal;
  }

  DVAL(): IGrammarVal {
    return {token: '["][^"]*["]'} as IGrammarVal;
  }
  ...
  NOTENAME(): IGrammarVal {
    return {token: '[a-gA-G]'} as IGrammarVal;
  }

  OCTAVE(): IGrammarVal {
    return {token: '[0-9]+'} as IGrammarVal;
  }

  ACCIDENTALS(): IGrammarVal {
    return {token: 'bbs|bb|bss|bs|b|db|d|##|#|n|\\+\\+-|\\+-|\\+\\+|\\+|k|o'} as IGrammarVal;
  }

  DURATIONS(): IGrammarVal {
    return {token: '[0-9whq]+'} as IGrammarVal;
  }

  TYPES(): IGrammarVal {
    return {token: '[rRsSxX]'} as IGrammarVal;
  }
  ...
  LBRACKET(): IGrammarVal {
    return {token: '\\['} as IGrammarVal;
  }

  RBRACKET(): IGrammarVal {
    return {token: '\\]'} as IGrammarVal;
  }
